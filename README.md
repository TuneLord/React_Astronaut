![React Astronaut](https://github.com/TuneLord/React_Astronaut/blob/gh-pages/static/media/LogoMain.47bde968.svg)
...
* **js** - app.js - main js that renders all components,
* **scss** - all scss files (divided into modules and partials).
