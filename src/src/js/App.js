            ...
            <>
                ...
                <ScrollableAnchor id={'section1'}>
                    <section className="news-section">
                        <h1 className="globaltitles-h1">Co nowego?</h1>
                        <article className="globalcontainer-flex">
                            <News icons={'fab fa-react fa-5x'} title={'React w wersji 16.7'} content={"React"}/>
                            <News icons={'fab fa-npm fa-5x'} title={'Npm w wersji 4.0.0'} content={"Npm"}/>
                            <News icons={'fab fa-node fa-5x'} title={'Node.js w wersji 10.14.2'} content={"Node"}/>
                ...
                <ScrollableAnchor id={'section2'}>
                    <section className='goodpractices-section'>
                        <h1 className="globaltitles-h1" style={{color: 'rgb(73, 80, 87)', margin: '40px 0'}}>Dobre praktyki</h1>
                        <article className={'globalcontainer'} style={{marginBottom: "20px"}}>
                ...
                <ScrollableAnchor id={'section3'}>
                    <section className='documentation globalcontainer-flex'>
                        <h1 className="globaltitles-h1">Dokumentacja</h1>
                        <article className={'globalcontainer'}>
